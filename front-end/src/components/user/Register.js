...
const Register = () => {
  ...
  const [avatarPreview, setAvatarPreview] = useState("/images/download.jpeg");
        ...
        <div className='col-10 col-lg-5 registration-form'>
          <form className='shadow-lg' onSubmit={submitHandler} encType='multipart/form-data'>
            ...
            <div className='form-group'>
              ...
              <input type='password' id='passwordConfirm_field' className='form-control'
              name='passwordConfirm' value={passwordConfirm} onChange={onChange}/>
            </div>
            <div className='form-group'>
              <label htmlFor='phoneNumber_field'>Phone Number</label>
              <input type='tel' id='phoneNumber_field' className='form-control'
            ...
            <div className='form-group'>
              ...
              <div className='d-flex align-items-center'>
                ...
                <div className='custom-file'>
                  <input type='file' name='avatar' className='custom-file-input'
                  id='customFile' accept='images/*' onChange={onChange}></input>

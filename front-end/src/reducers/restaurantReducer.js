import { ALL_RESTAURANTS_FAIL, ALL_RESTAURANTS_SUCCESS, ALL_RESTAURANTS_REQUEST, 
    CLEAR_ERRORS, SORT_BY_RATINGS, TOGGLE_VEG_ONLY, 
    SORT_BY_REVIEWS, } from "../constants/restaurantConstant";
const initialState = {
    restaurants: [],
};
    ...
    switch(action.type){
        ...
        case TOGGLE_VEG_ONLY:
            return{
                ...
                pureVegRestaurantsCount: calculatePureVegCount(state.restaurants.restaurants, 
                    !state.showVegOnly),
            };
